...
$(document).ready(function () {
    ...
    $('#confirm-btn').on('click', function (e) {
        ...
        saveTherapySessionDetails(assessment);
    });
...
function getAssignmentData() {
    return {
        ...
        frequency: $("#therapy-session-frequency").val(),
...
function loadReview() {
    ...
    $("#reviewSessionFrequency").text(getSelectedText("therapy-session-frequency"));
...
function saveTherapySessionDetails(request) {

    $.ajax({
        url: "/api/v1/assessment/save-therapy-session-details",
        type: "POST",
