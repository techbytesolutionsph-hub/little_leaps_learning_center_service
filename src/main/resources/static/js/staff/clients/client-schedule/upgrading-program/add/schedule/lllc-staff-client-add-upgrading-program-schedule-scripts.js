...
$(document).ready(function() {
    ...
    $("#addAssessmentScheduleForm").on("submit", function(event) {
        ...
        const request = buildAddUpgradingProgramSlotRequest();
        console.log("Request:", request);

        saveUpgradingProgramSlot(request);
    });
    ...
    $("#editAssessmentScheduleForm").on("submit", function(event) {
        ...
        const request = buildEditUpgradingProgramSlotRequest();
        console.log("Request:", request);

        updateUpgradingProgramSlot(request);
    });

    function buildAddUpgradingProgramSlotRequest() {
        return {
    ...
    function saveUpgradingProgramSlot(request) {

        $.ajax({
            url: "/api/v1/assessment/save-upgrading-program-slot",
            type: "POST",
            contentType: "application/json",
            dataType: "json",
            data: JSON.stringify(request),
            success: function(response) {
                console.log("Upgrading program slot saved successfully:", response);
            ...
            error: function(xhr) {
                console.error("Failed to save upgrading program slot:", xhr);
                if (xhr.responseJSON) {
    ...
    function updateUpgradingProgramSlot(request) {

        $.ajax({
            url: "/api/v1/assessment/update-upgrading-program-slot",
            type: "PUT",
            contentType: "application/json",
            dataType: "json",
            data: JSON.stringify(request),
